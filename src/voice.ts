...
export async function generateVoiceover(
  ...
  if (elevenLabsApiKey) {
    console.log(`🎙️ Generating premium voiceover with ElevenLabs...`);
    try {
  ...
  console.log(`🎙️ Generating Edge TTS voiceover...`);
  try {
    ...
    throw new Error(`Edge TTS generation failed: ${error.message}`);
  }
}
